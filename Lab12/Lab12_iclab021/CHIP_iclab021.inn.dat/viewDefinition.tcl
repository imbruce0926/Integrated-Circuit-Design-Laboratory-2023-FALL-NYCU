...
create_library_set -name lib_min\
   -timing\
    ...
    ${::IMEX::libVar}/mmmc/New_Img_SRAM_BC.lib\
    ${::IMEX::libVar}/mmmc/SRAM_Kernel_BC.lib\
    ${::IMEX::libVar}/mmmc/SRAM_Output_BC.lib]\
   -si\
...
create_library_set -name lib_max\
   -timing\
    ...
    ${::IMEX::libVar}/mmmc/New_Img_SRAM_WC.lib\
    ${::IMEX::libVar}/mmmc/SRAM_Kernel_WC.lib\
    ${::IMEX::libVar}/mmmc/SRAM_Output_WC.lib]\
   -si\
