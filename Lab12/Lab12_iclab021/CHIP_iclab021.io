...
(iopad
    (top
		...
		(inst  name="I_MATRIX__SIZE0"	place_status=placed )
		(inst  name="VDDC9"	place_status=placed )
		(inst  name="I_VALID_0"	place_status=placed )
    ...
    (right
		...
		(inst  name="I_MATRIX__SIZE1"	place_status=placed )
    ...
    (bottom
		...
		(inst  name="I_VALID_1"	place_status=placed )
		(inst  name="VDDC5"	place_status=placed )

		(inst  name="VDDPC"	place_status=placed )
		(inst  name="I_MATRIX_IDX2"	place_status=placed )
		(inst  name="GNDPC"	place_status=placed )
    ...
    (left
		...
		(inst  name="VDDPD"	place_status=placed )
		(inst  name="I_MATRIX_IDX3"	place_status=placed )
		(inst  name="GNDPD"	place_status=placed )
